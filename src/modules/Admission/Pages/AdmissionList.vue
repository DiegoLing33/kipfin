                ...
                <b-card title="Критерии отображения" class="mt-3">
                    ...
                    <b-row>
                        ...
                        <b-col md="3">
                            ...
                            <b-button
                                    :disabled="findId === ''"
                                    variant="info" block class="mb-3" size="sm"
                                    @click="$router.push('/user/' + findId)">
                                Перейти
                            </b-button>
                        </b-col>
                    </b-row>
...
<script lang="ts">
    ...
    import TextField from "@/core/Components/forms/fields/TextField.vue";
    import StoreLoader from "@/core/app/client/StoreLoader";
    import SelectField from "@/core/Components/forms/fields/SelectField.vue";
    import RadioField from "@/core/Components/forms/fields/RadioField.vue";
    ...
    import LoadMoreComponent from "@/modules/Interface/Components/toolbox/LoadMoreComponent.vue";
    import LiFlag from "@/modules/ling/components/LiFlag.vue";
    ...
    export default class AdmissionList extends Vue {
